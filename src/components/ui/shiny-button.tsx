...
import { motion, MotionProps, Target, Transition } from "framer-motion";
import React from "react";

const animationProps = {
  initial: { "--x": "100%", scale: 0.8 } as Target,
  animate: { "--x": "-100%", scale: 1 } as Target,
  whileTap: { scale: 0.95 } as Target,
  transition: {
    repeat: Infinity,
    repeatType: "loop",
    repeatDelay: 1,
